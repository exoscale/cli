...
func (m *MockS3API) HeadObject(ctx context.Context, input *s3.HeadObjectInput, optFns ...func(*s3.Options)) (*s3.HeadObjectOutput, error) {
	return m.mockHeadObject(ctx, input, optFns...)
}
