...
type sksCreateCmd struct {
	...
	NodepoolTaints               []string          `cli-flag:"nodepool-taint" cli-usage:"Kubernetes taint to apply to default Nodepool Nodes (format: KEY=VALUE:EFFECT or KEY=:EFFECT, can be specified multiple times)"`
