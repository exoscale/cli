...
<<<<<<< Updated upstream:cmd/dbaas_user_delete_opensearch.go
=======
	"github.com/exoscale/cli/utils"
	exoapi "github.com/exoscale/egoscale/v2/api"
>>>>>>> Stashed changes:cmd/dbaas/dbaas_user_delete_opensearch.go
...
=======
		}).showDatabaseServiceOpensearch(exoapi.WithEndpoint(exocmd.GContext, exoapi.NewReqEndpoint(account.CurrentAccount.Environment, c.Zone))))
>>>>>>> Stashed changes:cmd/dbaas/dbaas_user_delete_opensearch.go
	}
