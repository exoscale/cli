...
<<<<<<< Updated upstream:cmd/dbaas_user_delete_mysql.go
=======
	"github.com/exoscale/cli/utils"
	exoapi "github.com/exoscale/egoscale/v2/api"
>>>>>>> Stashed changes:cmd/dbaas/dbaas_user_delete_mysql.go
	v3 "github.com/exoscale/egoscale/v3"
	"github.com/spf13/cobra"
)

func (c *dbaasUserDeleteCmd) deleteMysql(cmd *cobra.Command, _ []string) error {
	...
	op, err := client.DeleteDBAASMysqlUser(ctx, c.Name, c.Username)
