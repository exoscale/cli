...
* When showing a Database Service notifications: %s`,
		...
		strings.Join(output.output.OutputterTemplateAnnotations(&dbServiceKafkaShowOutput{}), ", "),
		strings.Join(output.output.OutputterTemplateAnnotations(&dbServiceKafkaACLShowOutput{}), ", "),
		strings.Join(output.output.OutputterTemplateAnnotations(&dbServiceKafkaAuthenticationShowOutput{}), ", "),
		strings.Join(output.output.OutputterTemplateAnnotations(&dbServiceKafkaComponentShowOutput{}), ", "),
		strings.Join(output.output.OutputterTemplateAnnotations(&dbServiceKafkaConnectionInfoShowOutput{}), ", "),
		strings.Join(output.output.OutputterTemplateAnnotations(&dbServiceKafkaUserShowOutput{}), ", "),
		strings.Join(output.output.OutputterTemplateAnnotations(&dbServiceOpensearchShowOutput{}), ", "),
		strings.Join(output.output.OutputterTemplateAnnotations(&dbServiceMysqlShowOutput{}), ", "),
		strings.Join(output.output.OutputterTemplateAnnotations(&dbServiceMysqlComponentShowOutput{}), ", "),
		strings.Join(output.output.OutputterTemplateAnnotations(&dbServiceMysqlUserShowOutput{}), ", "),
		strings.Join(output.output.OutputterTemplateAnnotations(&dbServicePGShowOutput{}), ", "),
		strings.Join(output.output.OutputterTemplateAnnotations(&dbServicePGComponentShowOutput{}), ", "),
		strings.Join(output.output.OutputterTemplateAnnotations(&dbServicePGConnectionPool{}), ", "),
		strings.Join(output.output.OutputterTemplateAnnotations(&dbServicePGUserShowOutput{}), ", "),
		strings.Join(output.output.OutputterTemplateAnnotations(&dbServiceRedisShowOutput{}), ", "),
		strings.Join(output.output.OutputterTemplateAnnotations(&dbServiceRedisComponentShowOutput{}), ", "),
		strings.Join(output.output.OutputterTemplateAnnotations(&dbServiceRedisUserShowOutput{}), ", "),
		strings.Join(output.output.OutputterTemplateAnnotations(&dbServiceBackupListItemOutput{}), ", "),
		strings.Join(output.output.OutputterTemplateAnnotations(&dbServiceNotificationListItemOutput{}), ", "))
}
