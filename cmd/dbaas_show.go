...
* When showing a Database Service notifications: %s`,
		...
		strings.Join(output.OutputterTemplateAnnotations(&dbServiceKafkaShowOutput{}), ", "),
		strings.Join(output.OutputterTemplateAnnotations(&dbServiceKafkaACLShowOutput{}), ", "),
		strings.Join(output.OutputterTemplateAnnotations(&dbServiceKafkaAuthenticationShowOutput{}), ", "),
		strings.Join(output.OutputterTemplateAnnotations(&dbServiceKafkaComponentShowOutput{}), ", "),
		strings.Join(output.OutputterTemplateAnnotations(&dbServiceKafkaConnectionInfoShowOutput{}), ", "),
		strings.Join(output.OutputterTemplateAnnotations(&dbServiceKafkaUserShowOutput{}), ", "),
		strings.Join(output.OutputterTemplateAnnotations(&dbServiceOpensearchShowOutput{}), ", "),
		strings.Join(output.OutputterTemplateAnnotations(&dbServiceMysqlShowOutput{}), ", "),
		strings.Join(output.OutputterTemplateAnnotations(&dbServiceMysqlComponentShowOutput{}), ", "),
		strings.Join(output.OutputterTemplateAnnotations(&dbServiceMysqlUserShowOutput{}), ", "),
		strings.Join(output.OutputterTemplateAnnotations(&dbServicePGShowOutput{}), ", "),
		strings.Join(output.OutputterTemplateAnnotations(&dbServicePGComponentShowOutput{}), ", "),
		strings.Join(output.OutputterTemplateAnnotations(&dbServicePGConnectionPool{}), ", "),
		strings.Join(output.OutputterTemplateAnnotations(&dbServicePGUserShowOutput{}), ", "),
		strings.Join(output.OutputterTemplateAnnotations(&dbServiceRedisShowOutput{}), ", "),
		strings.Join(output.OutputterTemplateAnnotations(&dbServiceRedisComponentShowOutput{}), ", "),
		strings.Join(output.OutputterTemplateAnnotations(&dbServiceRedisUserShowOutput{}), ", "),
		strings.Join(output.OutputterTemplateAnnotations(&dbServiceBackupListItemOutput{}), ", "),
		strings.Join(output.OutputterTemplateAnnotations(&dbServiceNotificationListItemOutput{}), ", "))
}
