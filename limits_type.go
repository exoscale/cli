...
type ResourceLimit struct {
	...
	Project          string           `json:"project,omitempty" doc:"the project name of the resource limit"`
	ProjectID        string           `json:"projectid,omitempty" doc:"the project id of the resource limit"`
